  ...
  return (
    <main className='px-5 pb-16 pt-14 font-switzer text-black'>
      ...
      <section className='mx-auto mt-6 grid w-full max-w-[1280px] grid-cols-1 gap-5 lg:grid-cols-2'>
        <img src={study.gallery[0]} alt={`${study.title} gallery 1`} className='h-72 w-full rounded-lg object-cover' />
        <img src={study.gallery[1]} alt={`${study.title} gallery 2`} className='h-72 w-full rounded-lg object-cover' />
      </section>
      ...
      <section className='mx-auto mt-8 grid w-full max-w-[1280px] grid-cols-1 gap-5 lg:grid-cols-[1.05fr_0.95fr]'>
        ...
        <article className='rounded-lg border border-black/10 bg-[#f8f9fc] p-6'>
      ...
      <section className='mx-auto mt-10 w-full max-w-[1280px] rounded-lg border border-black/15 p-6 sm:p-8'>
