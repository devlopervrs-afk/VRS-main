...
export const allProjects = [
  ...
  { id: 3, title: 'Occ Homes Emrites Auction at Al Warsen Dubai', sector: 'Retail', location: 'Dubai', client: 'Owner', scope: 'Full Joinery Works', image: images.retail, featured: true },
  ...
  { id: 7, title: 'Prayer Room at Dubai Mall', sector: 'Commercial', location: 'Dubai Mall', client: 'Resolve(Emaar)', scope: 'Full Joinery Works', image: images.commercial, featured: true },
  ...
  { id: 27, title: 'G+1+R Villa at Polo Homes, Arabian Ranches', sector: 'Residential', location: 'Dubai', client: 'Ravi Hinduja', scope: 'Full Joinery Works', image: images.residential, featured: false },
