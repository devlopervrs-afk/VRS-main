...
function CredibilityBlock() {
  return (
    <section className='w-full px-4 pb-12 sm:px-6 sm:pb-16'>
      <div className='mx-auto w-full max-w-[1280px] overflow-hidden rounded-[28px] border border-[#1A3278]/10  p-6 shadow-[0_24px_60px_rgba(21,39,99,0.12)] sm:p-8 lg:p-10'>
        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4'>
          {credibilityStats.map((item) => (
            <article key={item.label} className='rounded-2xl border border-[#1A3278]/10 bg-white/80 p-5 shadow-[0_10px_28px_rgba(16,35,95,0.08)] backdrop-blur-sm'>
